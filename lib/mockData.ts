...
export const MOCK_LISTINGS: MockListing[] = [
  ...
  {
    id: 'mock-4',
    title: '3-Bedroom Bungalow in Asokoro',
    description:
      'Well-maintained 3-bedroom detached bungalow in a quiet Asokoro street. Includes a large garden, BQ, and ample parking. Walking distance to restaurants, schools, and government offices.',
    propertyType: 'BUNGALOW',
    bedrooms: 3,
    bathrooms: 2,
    addressLine: '5 Oke Street, Asokoro',
    area: 'Asokoro',
    city: 'Abuja',
    latitude: 9.0469,
    longitude: 7.5217,
    rentPerYear: '280000000',   // ₦2,800,000
    inspectionFee: '4000000',   // ₦40,000
    ...
    agent: {
      ...
      agentProfile: {
        agencyName: 'Capital Homes Abuja',
        profilePhoto: null,
        reputationScore: 780,
        isVerifiedBadge: true,
        city: 'Abuja',
        bio: 'Abuja-based agent specialising in Asokoro, Maitama, and Wuse II properties.',
      },
    },
  },
  {
    ...
    description:
      'Tastefully finished 2-bedroom flat in Wuse 2 — Abuja central district. Open-plan kitchen, ceramic floors, and a rooftop terrace. 24/7 security and estate management.',
    propertyType: 'FLAT',
    bedrooms: 2,
    bathrooms: 2,
    addressLine: '18 Aminu Kano Crescent, Wuse 2',
    area: 'Wuse 2',
    city: 'Abuja',
    latitude: 9.0728,
    longitude: 7.4891,
